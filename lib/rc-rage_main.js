...
var result_string = 'trial steal_timing finish_code click_cnt wasted_click points rt time_remain;';
        ...
        var continuous_rage = {
            ...
            on_finish: function (data) {
                ...
                if (time_limit > 0 || data.finish_code == 99) {
                    ...
                    //results_string = 'trial steal_timing finish_code click_cnt wasted_click points rt time_remain;';
                    result_string += data.trial_cnt + ' ' + // trial
                        ...
                        data.wasted_click.toString() + ' ' + // wasted_click
