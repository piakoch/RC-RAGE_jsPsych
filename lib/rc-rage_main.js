...
function generate_instruction_block(imglist, takeBackAmount = take_back_amount) {
    ...
    var RAGE_instruction_page_1_3_intro_ctd = {
        type: 'instructions',
        pages: [
        ...
        data: {
            exp_stage: 'RC-RAGE_instruction_page_1_3_intro_ctd',
            task_id: function () {
                return task_id;
            },
            sbj_id: function () {
    ...
    block_instruction.push(RAGE_instruction_page_1_3_intro_ctd);
