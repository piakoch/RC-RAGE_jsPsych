    ...
    plugin.info = {
        ...
        parameters: {
            ...
            sound_gunshot: {
                ...
                default: 'https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/sounds/MP5_SMG-plus-pain.wav',
                description: 'Sound for shooting the robber'
            },
            sound_dying: {
                type: jsPsych.plugins.parameterType.AUDIO,
                pretty_name: 'Sound dying',
                default: 'https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/sounds/202037__thestigmata__man-die.wav',
