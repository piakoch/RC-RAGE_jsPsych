    ...
    plugin.info = {
        ...
        parameters: {
            ...
            sound_steal: {
                ...
                default: 'https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/sounds/170623__jorickhoofd__funny-high-giggle.wav',
                description: 'Sound for the robber appearing and stealing points'
            },
            // alternative: https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/sounds/MP5_SMG-plus-pain.wav
            sound_gunshot: {
                type: jsPsych.plugins.parameterType.AUDIO,
                pretty_name: 'Sound gunshot',
                default: 'https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/sounds/gunshot1.wav',
                description: 'Sound for shooting the robber'
            },
            // alternative: https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/sounds/202037__thestigmata__man-die.wav
            sound_dying: {
                type: jsPsych.plugins.parameterType.AUDIO,
            ...
            sound_escape: {
                ...
                default: 'https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/sounds/Yahoo-SoundBible.com-1888534056.wav',
            ...
            robber_happy: {
                ...
                default: 'https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/lib/Smily_happy_40px.png',
                description: 'An alive robber image'
            },
            robber_dead: {
                type: jsPsych.plugins.parameterType.IMAGE,
                pretty_name: 'Robber dead',
                default: 'https://raw.githubusercontent.com/kywch/RC-RAGE_jsPsych/master/lib/smiley_dead_KLM_40px.png',
    ...
    plugin.trial = function (display_element, trial) {
        ...
        */
        ...
        function jumpRedSquare() {
            ...
            // put escape message:
            jQuery("#jspsych-robber-escape").text('The robber escapes with your money after ' + square_escape.toString() + ' clicks!');
            /*
            ...
            if (square_dead == false) {
                ...
                if (square_click >= trial.kill_click) {
                    ...
                    if (trial.takeback_amount > 0) {
                        ...
                        jQuery("#jspsych-robber-escape").text('The robber bit the dust.');
                    }
